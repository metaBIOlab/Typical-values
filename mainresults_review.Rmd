...
T_a <- ggplot(filter(dados_datasetscomp, ROI == "hemisphere", Diagnostic == "CTL"), aes(x = Age, y = AvgThickness, alpha = 0.4))+
    ...
    geom_smooth(method = "lm", color = "black", aes(alpha = 0.4)) +
    geom_smooth(aes(color = Sample, fill = Sample), method = "lm", alpha = 0.4, size = 0.5) +
    theme_pubr() + 
    guides(alpha = "none") +
    labs(y = "T") +
    scale_x_continuous(limits = c(0,100))
...
ggsave("harmonization.jpg", plot = harmonization, width = 18, height = 22, units = "cm", device = "jpg")
...
ggsave("lifespan_shift.jpg", plot = lifespan_shift, width = 18, height = 16, units = "cm", device = "jpg")
...
ggsave("fig_slope_ageinterval_AD.jpg", plot = fig_slope_ageinterval_AD, width = 18, height = 14, units = "cm", device = "jpg")
```
...
ggsave("fig_age_c.jpg", plot = fig_age_c, width = 18, height = 18, units = "cm", device = "jpg")
```
