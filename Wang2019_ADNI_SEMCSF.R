# ADNI ####
## Hemisphere #####
ADNI <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI.csv")
ADNI <-
...
## Lobes #####
### Total Area #####
ADNI_TotalArea_L <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_TotalArea_L.csv", 
                            col_names = FALSE)
...
ADNI_TotalArea_R <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_TotalArea_R.csv", 
                            col_names = FALSE)
...
### Avg Thickness #####
ADNI_T_L <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_T_L.csv", 
                    col_names = FALSE)
...
ADNI_T_R <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_T_R.csv", 
                    col_names = FALSE)
...
### Exposed Area #####
ADNI_SmoothArea_L <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_SmoothArea_L.csv", 
                             col_names = FALSE)
...
ADNI_SmoothArea_R <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_SmoothArea_R.csv", 
                             col_names = FALSE)
...
### Exposed Area CHwoB#####
ADNI_SmoothArea_CHwoB_L <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_SmoothArea_CHwoB_L.csv", 
                                   col_names = FALSE)
...
ADNI_SmoothArea_CHwoB_R <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_SmoothArea_CHwoB_R.csv", 
                                   col_names = FALSE)
...
### Gaussian Curvature#####
ADNI_K_CHwoB_L <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_K_CHwoB_L.csv", 
                                    col_names = FALSE)
ADNI_K_CHwoB_L <- cbind(ADNI_subj, ADNI_K_CHwoB_L)

ADNI_K_CHwoB_L <- ADNI_K_CHwoB_L  %>%
  mutate(hemi = "L") %>%
  pivot_longer(X1:X6, names_to = "ROI", values_to = "K_CHwoB")

ADNI_K_CHwoB_R <- read_csv("C:/Users/ferna/Documents/idor/Gyrification/data/Wang2016e2019/ADNI_K_CHwoB_R.csv", 
                                    col_names = FALSE)
ADNI_K_CHwoB_R <- cbind(ADNI_subj, ADNI_K_CHwoB_R)

ADNI_K_CHwoB_R <- ADNI_K_CHwoB_R %>%
  mutate(hemi = "R") %>%
  pivot_longer(X1:X6, names_to = "ROI", values_to = "K_CHwoB")

ADNI_K_CHwoB <- rbind(ADNI_K_CHwoB_L, ADNI_K_CHwoB_R)
ADNI_K_CHwoB$SUBJ <- as.character(ADNI_K_CHwoB$SUBJ)

## ADNI #####
ADNI <- full_join(ADNI_T, ADNI_SmoothArea) %>%
  full_join(ADNI_TotalArea) %>%
  full_join(ADNI_SmoothArea_CHwoB) %>%
  full_join(ADNI_K_CHwoB) %>%
